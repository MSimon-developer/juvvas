...
from .views import get_properties,home, update_property, get_property_detail, delete_property, BookAirbnbView, FavoriteToggleView, FavoriteListView, AllBookingsView, PropertyListCreateView
